...
train_fp = ['./final_all_data/exercise_contest/data_train.json']
eval_fp = ['./final_all_data/exercise_contest/data_test.json']
...
train_spec = TrainSpec(input_fn=lambda: input_fn(train_fp), max_steps=200)
